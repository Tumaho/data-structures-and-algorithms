...
const firstLetters = (arr) => {
  // Solution code here...
  let lett  = arr.map(string => string.charAt(0));
    return lett;
...
const onlyOddChars = (str) => {
  // Solution code here...
  let oddChar = str.split('').filter((val, index) => index % 2).join('');
  return oddChar;
};
...
const allHappy = (arr) => {
  // Solution code here...
  let happy = arr.every(val => val.includes(':)'));
    return happy;
};
...
const findAnything = (arr, target) => {
  // Solution code here...
  let anything =  arr.filter(val => val.includes(target));
  return anything;
};
...
const findEvery = (arr, target) => {
  // Solution code here...
  let every = arr.every(val => val.includes(target));
    return every;
};
...
const unenrollBrook = (arr) => {
  // Solution code here...
  let unenroll = arr.map(currentArray => currentArray.filter(string => !string.includes('Brook')));
    return unenroll;
};
...
const characterByIndex = (arr) => {
  // Solution code here...
  let char = arr.map((val, index) =>  val.charAt(index));
        return char;
};
