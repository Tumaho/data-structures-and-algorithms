...
Write a function named sortNumbersByLength that takes in an array of numbers and sorts those numbers by 
their length.
...
lastName, and age properties, and sorts those people by their last names. Do not worry about capitalization 
or first names.
------------------------------------------------------------------------------------------------ */
...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  arr.sort((a,b)=>{
  var dCount = a.lastName > b.lastName;
  if(dCount) return dCount;
  var first = a.firstName > b.firstName;
